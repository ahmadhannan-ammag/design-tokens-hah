...
const fontFamilies_1 = require("./fontFamilies");
const fontSizes_1 = require("./fontSizes");
const fontWeights_1 = require("./fontWeights");
const letterSpacing_1 = require("./letterSpacing");
const lineHeights_1 = require("./lineHeights");
/* eslint-enable jsdoc/check-property-names, jsdoc/tag-lines */
exports.typography = {
    sDisplayMD: {
        fontFamily: fontFamilies_1.fontFamilies.euclidCircularB,
    ...
    sBodyXS: {
        fontFamily: fontFamilies_1.fontFamilies.euclidCircularB,
        fontWeight: fontWeights_1.fontWeights.regular,
        fontSize: fontSizes_1.fontSizes.fontSize1,
        lineHeight: lineHeights_1.lineHeights.lineHeight1,
